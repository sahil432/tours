...
The J Navi Entity Clone module now includes comprehensive multilingual support! You can now clone entities with all their translations or select specific language versions.
...
- `j_navi_entity_clone.services.yml` - Added language manager dependency
- `config/schema/j_navi_entity_clone.schema.yml` - Added translation config
- `j_navi_entity_clone.info.yml` - Added language dependencies
...
### Configuration
1. Navigate to `/admin/config/content/j-navi-entity-clone`
...
**Multilingual support is now a core feature of J Navi Entity Clone!**
