...
J Navi Entity Clone provides comprehensive multilingual support, allowing you to clone entities with all their translations or select specific language versions. This is particularly useful for content migration, multilingual workflows, and content type restructuring in multilingual Drupal sites.
...
1. Navigate to **Admin > Configuration > Content > J Navi Entity Clone**
...
5. Review logs for errors: `drush watchdog:show --type=j_navi_entity_clone`
