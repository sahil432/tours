# Entity Clone Mapper - Technical Specification

## Module Information

**Name:** Entity Clone Mapper  
**Machine Name:** entity_clone_mapper  
**Version:** 1.0.0  
**Drupal Version:** 11.x  
**Package:** Custom  
**Type:** Module  
...
```php
\Drupal::service('entity_clone_mapper.clone_service')
```
...
|-----------|------|---------|
| entity_clone_mapper.settings | /admin/config/content/entity-clone-mapper | Configuration form |
| entity_clone_mapper.clone_entity | /entity-clone-mapper/clone/{entity_type}/{entity} | Clone handler |

### Permissions

| Permission | Machine Name | Description |
|-----------|--------------|-------------|
| Administer Entity Clone Mapper | administer entity clone mapper | Access configuration |
...
- File: `entity_clone_mapper.settings`
...
| Event | Level | Channel |
|-------|-------|---------|
| Successful clone | Info | entity_clone_mapper |
| Field mapping error | Warning | entity_clone_mapper |
| Clone failure | Error | entity_clone_mapper |
| Missing field | Warning | entity_clone_mapper |
...
use Drupal\entity_clone_mapper\Service\EntityCloneService;
