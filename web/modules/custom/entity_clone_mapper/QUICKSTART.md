# Entity Clone Mapper - Quick Start Guide

## What This Module Does

Entity Clone Mapper allows you to clone Drupal entities (nodes and taxonomy terms) from one type to another with configurable field mappings. Perfect for:
...
```bash
cd /path/to/drupal
cp -r entity_clone_mapper web/modules/custom/
drush en entity_clone_mapper -y
drush cr
```

**Via UI:**
- Upload to `/modules/custom/entity_clone_mapper`
- Visit Admin > Extend
- Enable "Entity Clone Mapper"
...
- ✅ **Administer Entity Clone Mapper** (for admins)
- ✅ **Clone Entities** (for content editors)

### 3. Configure Your First Mapping

Visit **Admin > Config > Content > Entity Clone Mapper** (`/admin/config/content/entity-clone-mapper`)
...
```
entity_clone_mapper/
├── entity_clone_mapper.info.yml          # Module definition
├── entity_clone_mapper.module            # Hooks and form alterations
├── entity_clone_mapper.routing.yml       # URL routes
├── entity_clone_mapper.permissions.yml   # Permission definitions
├── entity_clone_mapper.services.yml      # Service container
├── entity_clone_mapper.links.menu.yml   # Admin menu links
├── README.md                             # Full documentation
├── INSTALL.md                            # Installation guide
├── CHANGELOG.md                          # Version history
├── config/
│   ├── install/
│   │   └── entity_clone_mapper.settings.yml
│   └── schema/
│       └── entity_clone_mapper.schema.yml
└── src/
    ├── Controller/
...
`/admin/config/content/entity-clone-mapper`
